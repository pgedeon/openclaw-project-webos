...
7. **OpenClaw Config** - Read /root/.openclaw/openclaw.json. Are all agents configured properly? Any using deprecated models or missing fallbacks?

8. **Cron Jobs** - Run: crontab -l. Check /root/.openclaw/workspace/crontab/ for job definitions. Any broken paths or missing scripts?
