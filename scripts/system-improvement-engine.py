...
def gather_system_state() -> dict:
    ...
    cron_logs = {
        "dashboard_health": "/root/.openclaw/workspace/logs/dashboard-health.cron.log",
        "error_rate": "/root/.openclaw/workspace/logs/error-rate.cron.log",
        "citation_improvement": "/root/.openclaw/workspace/logs/citation-improvement.cron.log",
        "sync_gateway": "/root/.openclaw/workspace/logs/sync-gateway-status.log",
        "models_catalog": "/root/.openclaw/workspace/logs/sync-models-catalog.log",
    }
    import subprocess
    state["cron_health"] = {}
