...
const MEMORY_DIR = 'OPENCLAW_MEMORY_DIR';
const MEMORY_ROOT = 'OPENCLAW_MEMORY_ROOT';
const FACTS_SCRIPT = 'OPENCLAW_FACTS_SCRIPT';
const UNIFIED_SCRIPT = 'OPENCLAW_UNIFIED_SCRIPT';
